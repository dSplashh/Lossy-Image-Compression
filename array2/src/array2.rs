...
impl<T: Clone> Array2<T> {
    ...
    // Public method to access the data field
    pub fn get_data(&self) -> &Vec<T> {
        &self.data
    }

    pub fn remove(&mut self, c: usize, r: usize){
        self.data.remove(self.get_index(c, r).unwrap());
    }

    pub fn mod_width(&mut self, new_width: usize) {
        self.width = new_width;
    }

    pub fn mod_height(&mut self, new_height: usize) {
        self.width = new_height;
    }

    pub fn set(&mut self, c: usize, r: usize, value: T) {
